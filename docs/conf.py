...
project = u'Django Media Tree'
copyright = u'2011, Samuel Luescher'
...
htmlhelp_basename = 'DjangoMediaTreedoc'
...
latex_documents = [
  ('index', 'DjangoMediaTree.tex', u'Django Media Tree Documentation',
   u'Samuel Luescher', 'manual'),
]
...
man_pages = [
    ('index', 'djangomediatree', u'Django Media Tree Documentation',
     [u'Samuel Luescher'], 1)
]
