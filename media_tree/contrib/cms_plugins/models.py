...
class MediaTreeImage(CMSPlugin):
    ...
    link_type = models.CharField(_('link type'), max_length=1, blank=True, null=True, default=app_settings.MEDIA_TREE_CMS_PLUGIN_LINK_TYPE_DEFAULT, choices=app_settings.MEDIA_TREE_CMS_PLUGIN_LINK_TYPE_CHOICES, help_text=_('Makes the image a clickable link.'))
