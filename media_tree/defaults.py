...
MEDIA_TREE_ALLOWED_FILE_TYPES = (
    'aac', 'ace', 'ai', 'aiff', 'avi', 'bmp', 'dir', 'doc', 'docx', 'dmg', 'eps', 'fla', 'flv', 'gif', 'gz', 'hqx', 'htm', 'html', 'ico', 'indd', 'inx', 'jpg', 'jar', 'jpeg', 'md', 'mov', 'mp3', 'mpc', 'mpg', 'mpeg', 'ogg', 'odg', 'odf', 'odp', 'ods', 'odt', 'otf', 'pdf', 'png', 'pps', 'ppsx', 'ps', 'psd', 'rar', 'rm', 'rtf', 'sit', 'swf', 'tar', 'tga', 'tif', 'tiff', 'ttf', 'txt', 'wav', 'wma', 'wmv', 'xls', 'xlsx', 'xml', 'zip'
)

MEDIA_TREE_THUMBNAIL_EXTENSIONS = ('jpg', 'png')

MEDIA_TREE_MEDIA_EXTENDERS = (
    'media_tree.media_extenders.core.images.ExifIptcExtender',
)
