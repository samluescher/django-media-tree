...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('cms_media_plugins_mediatreegalleryitem', 'media_tree_cms_plugins_mediatreegalleryitem')
        db.rename_table('cms_media_plugins_mediatreelistitem', 'media_tree_cms_plugins_mediatreelistitem')
        db.rename_table('cms_media_plugins_mediatreeslideshowitem', 'media_tree_cms_plugins_mediatreeslideshowitem')

    def backwards(self, orm):
        db.rename_table('media_tree_cms_plugins_mediatreegalleryitem', 'cms_media_plugins_mediatreegalleryitem')
        db.rename_table('media_tree_cms_plugins_mediatreelistitem', 'cms_media_plugins_mediatreelistitem')
        db.rename_table('media_tree_cms_plugins_mediatreeslideshowitem', 'cms_media_plugins_mediatreeslideshowitem')
