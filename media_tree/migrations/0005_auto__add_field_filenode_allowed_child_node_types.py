...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileNode.allowed_child_node_types'
        db.add_column(u'media_tree_filenode', 'allowed_child_node_types',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileNode.allowed_child_node_types'
        db.delete_column(u'media_tree_filenode', 'allowed_child_node_types')
    ...
    models = {
        ...
        u'media_tree.filenode': {
            ...
            'allowed_child_node_types': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
