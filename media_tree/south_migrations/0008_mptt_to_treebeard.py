...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename tree attributes from mptt to treebeard
        db.rename_column(u'media_tree_filenode', u'rght', u'rgt')
        db.rename_column(u'media_tree_filenode', u'level', u'depth')

    def backwards(self, orm):
        # Rename tree attributes from treebeard to mptt
        db.rename_column(u'media_tree_filenode', u'rgt', u'rght')
        db.rename_column(u'media_tree_filenode', u'depth', u'level')
